...
export const Journal = () => {
  ...
  const handleSave = () => {
    ...
    if (navigator.vibrate) navigator.vibrate([15, 30, 15]); // 成功觸覺回饋
  };
          ...
          <div className="fixed inset-0 z-[2000] flex items-center justify-center p-6">
             ...
             >
                <div className="aspect-square bg-gray-100 mb-4 border-[3px] border-splat-dark overflow-hidden">
                   <img src={viewingItem.images[0]} className="w-full h-full object-cover" alt="food" />
                </div>
  ...
  return (
    ...
    >
      <div className="aspect-square bg-gray-50 border-2 border-splat-dark mb-3 overflow-hidden relative">
         <img src={item.images[0]} loading="lazy" className="w-full h-full object-cover" alt="food" />
